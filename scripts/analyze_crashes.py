    ...
    for crash_file in crash_files:
        try:
            ...
            config_patterns.append({
                ...
                'outbound_types': [o.get('type') for o in config.get('outbounds', []) if isinstance(o, dict)],
                'inbound_types': [i.get('type') for i in config.get('inbounds', []) if isinstance(i, dict)]
            })
