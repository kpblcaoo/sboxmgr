...
class SingBoxModelBase(BaseModel):
    ...
    def smart_dump(self, exclude_unset: bool = True, exclude_none: bool = True) -> Dict[str, Any]:
    ...
    def _cleanup_by_type(self, data: Dict[str, Any], protocol_type: str) -> Dict[str, Any]:
        ...
        transport_supported = {
            'vmess', 'vless', 'trojan', 'tuic', 'hysteria2', 'shadowsocks', 'shadowtls'
        }
        
        # Define which protocols support TLS
        tls_supported = {
            'vmess', 'vless', 'trojan', 'tuic', 'hysteria2', 'http', 'shadowtls', 'anytls', 'naive'
        }
