...
class ClashApiConfig(BaseModel):
    ...
    default_mode: Optional[str] = Field(default=None, description="Default proxy mode, e.g., 'rule'.")
...
class V2RayApiConfig(BaseModel):
    ...
    stats_outbound_uplink: Optional[bool] = Field(default=None, description="Enable outbound uplink stats.")
...
class CacheFileConfig(BaseModel):
    ...
    store_fakeip: Optional[bool] = Field(default=None, description="Store fake IP mappings.")
