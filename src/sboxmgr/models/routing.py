...
class RouteRule(BaseModel):
    ...
    protocol: Optional[Union[str, List[str]]] = Field(default=None, description="Protocols to match, e.g., 'dns' or ['http', 'tls'].")
...
class RouteConfig(BaseModel):
    ...
    default_interface: Optional[str] = Field(default=None, description="Default network interface.")
    default_mark: Optional[int] = Field(default=None, ge=0, description="Default routing mark.")
