...
- **Total main commands**: 8

- **Total subcommands**: 27

- **Total commands**: 35

- **Show details**: False

- **Generated**: 2025-07-19 20:33:37


## Command Groups Overview

- **`sboxctl lang`**: 0 subcommands

- **`sboxctl test`**: 0 subcommands

- **`sboxctl tui`**: 0 subcommands

- **`sboxctl config`**: 8 subcommands

- **`sboxctl subscription`**: 2 subcommands
