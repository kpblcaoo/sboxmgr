...
class TestGeoFilterPostProcessor:
    ...
    def test_geo_filtering(self):
        ...
        servers = [
            ParsedServer(type='vmess', address='us.server.com', port=443, meta={'country': 'US'}),
            ParsedServer(type='vmess', address='ca.server.com', port=443, meta={'country': 'CA'}),
            ParsedServer(type='vmess', address='cn.server.com', port=443, meta={'country': 'CN'}),
...
class TestTagFilterPostProcessor:
    ...
    def test_tag_filtering(self):
        ...
        servers = [
            ...
            ParsedServer(type='vmess', address='test4.com', port=443, tag='PREMIUM'),  # Case test
        ]
...
class TestLatencySortPostProcessor:
    ...
    def test_latency_sorting(self):
        ...
        servers = [
            ParsedServer(type='vmess', address='slow.com', port=443, meta={'latency_ms': 300}),
            ParsedServer(type='vmess', address='fast.com', port=443, meta={'latency_ms': 50}),
            ParsedServer(type='vmess', address='medium.com', port=443, meta={'latency_ms': 150}),
        ]
...
class TestPostProcessorChain:
    ...
    def test_sequential_execution(self):
        ...
        chain = PostProcessorChain([processor1, processor2], {'execution_mode': 'sequential'})
        context = PipelineContext()
    ...
    def test_error_handling(self):
        ...
        assert 'Mock' in chain._execution_metadata['processors_failed'][0]['name'] or 'BasePostProcessor' in chain._execution_metadata['processors_failed'][0]['name']
