...
from sboxmgr.cli.commands.config import _output_env_format, config_app
...
"""
        ...
        result = self.runner.invoke(
            config_app, ["dump", "--config-file", str(config_file)]
        )
    ...
    def test_dump_config_with_invalid_config_file(self):
        ...
        result = self.runner.invoke(
            config_app, ["dump", "--config-file", "/nonexistent.toml"]
        )
...
class TestConfigSchemaCommand:
    ...
    def test_generate_schema_to_file(self, tmp_path):
        ...
        result = self.runner.invoke(
            config_app, ["schema", "--output", str(output_file)]
        )
...
class TestOutputEnvFormat:
    ...
    def test_output_env_format_basic_data(self, capsys):
        ...
        test_data = {"logging": {"level": "DEBUG"}, "service": {"service_mode": True}}
    ...
    def test_output_env_format_skips_metadata(self, capsys):
        ...
        test_data = {"logging": {"level": "INFO"}, "_metadata": {"internal": "value"}}
    ...
    def test_output_env_format_list_handling(self, capsys):
        ...
        test_data = {"logging": {"sinks": ["stdout", "journald"]}}
