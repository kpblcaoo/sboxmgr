...
class TestPolicyEngineEnhanced:
    ...
    def test_evaluate_all_multiple_policies(self):
        ...
        self.engine.register(MockPolicy("AllowPolicy", result=PolicyResult.allow("Allow")))
        self.engine.register(MockPolicy("WarningPolicy", result=PolicyResult.warning("Warning")))
        self.engine.register(MockPolicy("DenyPolicy", result=PolicyResult.deny("Deny")))
        self.engine.register(MockPolicy("AllowPolicy2", result=PolicyResult.allow("Allow2")))
    ...
    def test_evaluate_all_disabled_policy(self):
        ...
        policy = MockPolicy("DisabledPolicy", result=PolicyResult.deny("Should not run"))
    ...
    def test_evaluate_all_policy_exception(self):
        ...
        self.engine.register(MockPolicy("NormalPolicy", result=PolicyResult.allow("Normal")))
