...
from sboxmgr.cli.main import SUPPORTED_PROTOCOLS, is_ai_lang
...
class TestIsAiLang:
    ...
    def test_is_ai_lang_true(self, tmp_path):
        ...
        with patch("sboxmgr.cli.main.Path") as mock_path:
            ...
            with patch(
                "builtins.open",
                mock_open(
                    read_data='{"cli": {"help": "Hilfe"}, "__note__": "AI-generated translations - needs review"}'
                ),
            ):
    ...
    def test_is_ai_lang_false(self, tmp_path):
        ...
        with patch("sboxmgr.cli.main.Path") as mock_path:
            ...
            with patch(
                "builtins.open",
                mock_open(
                    read_data='{"cli": {"help": "Help"}, "__note__": "Human-reviewed"}'
                ),
            ):
    ...
    def test_is_ai_lang_no_note(self, tmp_path):
        ...
        with patch("sboxmgr.cli.main.Path") as mock_path:
            mock_path.return_value.parent.parent = tmp_path
            with patch(
                "builtins.open", mock_open(read_data='{"cli": {"help": "Help"}}')
            ):
                result = is_ai_lang("en")
                assert result is False
