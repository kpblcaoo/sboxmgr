...
class TestPydanticMigration:
    ...
    def test_orchestrator_config_pydantic(self):
        ...
        config = OrchestratorConfig(
            default_mode="strict", debug_level=2, timeout_seconds=60
        )
    ...
    def test_profiles_pydantic(self):
        ...
        sub_profile = SubscriptionProfile(
            id="test-subscription", enabled=True, priority=2
        )
        ...
        full_profile = FullProfile(
            id="test-profile", description="Test profile", subscriptions=[sub_profile]
        )
